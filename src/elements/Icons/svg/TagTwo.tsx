...
const TagTwo: React.FC = props => {
  const {  } = props

  return (
    <svg className={``} width="27" height="26" viewBox="0 0 27 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M9.384 11.5253L7.5 9.6293L9.384 7.7453" stroke="#292D32" stroke-width="1.9894" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  )
}
